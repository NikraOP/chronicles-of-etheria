            ...
            'Школа Оружия': [
                {
                    ...
                    name: 'Базовый',
                    icon: '⚔️',
                    img: 'classes/warrior/male/weapons.png',
                    price: 0,
                    rarity: 'Обычный',
            ...
            'Школа Снайпера': [
                {
                    ...
                    name: 'Базовый',
                    icon: '🎯',
                    img: 'classes/archer/male/sniper.png',
                    price: 0,
                    rarity: 'Обычный',
                ...
                {
                    id: 'archer_sniper_deadeye_m',
                    name: 'Смертельный глаз',
                    icon: '👁️',
                    img: 'classes/archer/male/sniper_deadeye.png',
                    price: 15000,
                    rarity: 'Эпический',
                ...
                {
                    id: 'archer_sniper_dragonslayer_m',
                    name: 'Футурестичный костюм',
                    icon: '🐉',
                    img: 'classes/archer/sniper-future.png',
                    price: 8000,
                    rarity: 'Легендарный',
                    description: 'Образ легендарного охотника на драконов',
                    gender: 'male'
                }
            ],
            'Школа Охотника': [
                {
                    ...
                    name: 'Базовый',
                    icon: '🏹',
                    img: 'classes/archer/male/oxot.png',
                    price: 0,
                    rarity: 'Обычный',
            ...
            'Школа Выживания': [
                {
                    ...
                    name: 'Базовый',
                    icon: '🌿',
                    img: 'classes/archer/male/vig.png',
                    price: 0,
                    rarity: 'Обычный',
