...
const CRAFTING_RECIPES = {
    ...
    'blacksmith': {
        weapons: [
            ...
            {name:'Клинок разрушителя миров',icon:'🌌',img:'',tier:6,exp:1200,time:20,resources:{'Орихалк':10,'Звездный камень':5,'Камень душ':3},type:'weapon',class:'Воин',rarity:'Божественный',dmg:96,def:22,hp:240,crit:30,critDmg:66,baseDmg:96},
            {name:'Топор армагеддона',icon:'☠️',img:'',tier:6,exp:1300,time:20,resources:{'Орихалк':12,'Звездный камень':5,'Шкура титана':3},type:'weapon',class:'Воин',rarity:'Божественный',dmg:132,def:26,hp:312,crit:34,critDmg:78,baseDmg:132},
            {name:'Меч богов',icon:'⚜️',img:'',tier:6,exp:1500,time:22,resources:{'Орихалк':14,'Звездный камень':6,'Камень душ':5},type:'weapon',class:'Воин',rarity:'Божественный',dmg:156,def:34,hp:420,crit:38,critDmg:90,baseDmg:156},
            {name:'Оружие Судьбы',icon:'🔱',img:'',tier:6,exp:1800,time:25,resources:{'Орихалк':15,'Звездный камень':8,'Камень душ':6,'Шкура титана':5},type:'weapon',class:'Воин',rarity:'Божественный',dmg:180,def:38,hp:540,crit:42,critDmg:102,baseDmg:180}
        ],
        armor: [
    ...
    'leatherworking': {
        weapons: [
            ...
            {name:'Лук судьбы',icon:'🎯',img:'',tier:6,exp:1100,time:20,resources:{'Орихалк':9,'Древесина мирового древа':8,'Шкура левиафана':3,'Звездный камень':5,'Камень душ':3},type:'weapon',class:'Лучник',rarity:'Божественный',dmg:126,hp:144,crit:36,critDmg:78,dodge:19,baseDmg:126},
            {name:'Арбалет возмездия',icon:'⚡',img:'',tier:6,exp:1200,time:20,resources:{'Орихалк':10,'Древесина мирового древа':8,'Шкура левиафана':3,'Звездный камень':5,'Камень душ':3},type:'weapon',class:'Лучник',rarity:'Божественный',dmg:150,hp:180,crit:41,critDmg:90,dodge:22,baseDmg:150},
            {name:'Лук небесного охотника',icon:'🌟',img:'',tier:6,exp:1400,time:22,resources:{'Орихалк':12,'Древесина мирового древа':9,'Шкура левиафана':4,'Звездный камень':6,'Камень душ':5},type:'weapon',class:'Лучник',rarity:'Божественный',dmg:174,hp:216,crit:46,critDmg:102,dodge:24,baseDmg:174},
            {name:'Оружие перворожденных',icon:'🔱',img:'',tier:6,exp:1600,time:25,resources:{'Орихалк':14,'Древесина мирового древа':10,'Шкура левиафана':4,'Звездный камень':8,'Камень душ':6},type:'weapon',class:'Лучник',rarity:'Божественный',dmg:204,hp:264,crit:50,critDmg:120,dodge:29,baseDmg:204}
        ],
        armor: [
    ...
    'tailoring': {
        weapons: [
            {name:'Дубовый посох',icon:'🪄',img:'',tier:1,exp:55,time:4,resources:{'Дубовая древесина':6,'Паутина':3},type:'weapon',class:'Маг',rarity:'Обычный',dmg:10,hp:18,baseDmg:10},
            {name:'Кристальный скипетр',icon:'💠',img:'',tier:1,exp:60,time:4,resources:{'Медная руда':5,'Аметист':2,'Паутина':3},type:'weapon',class:'Маг',rarity:'Обычный',dmg:12,crit:5,baseDmg:12},
            {name:'Посох элементаля',icon:'🌍',img:'',tier:2,exp:120,time:5,resources:{'Серебряная руда':5,'Аметист':3,'Шёлк':3},type:'weapon',class:'Маг',rarity:'Необычный',dmg:18,hp:24,crit:10,baseDmg:18},
            {name:'Скипетр мудреца',icon:'📜',img:'',tier:2,exp:130,time:5,resources:{'Серебряная руда':5,'Сапфир':2,'Шёлк':5},type:'weapon',class:'Маг',rarity:'Необычный',dmg:20,critDmg:22,dodge:4,baseDmg:20},
            {name:'Посох архимага',icon:'🧙',img:'',tier:3,exp:260,time:7,resources:{'Золотая руда':5,'Рубин':2,'Мифриловая нить':3},type:'weapon',class:'Маг',rarity:'Редкий',dmg:26,crit:12,critDmg:22,baseDmg:26},
            {name:'Скипетр волшебника',icon:'✨',img:'',tier:3,exp:280,time:7,resources:{'Золотая руда':5,'Изумруд':2,'Мифриловая нить':3},type:'weapon',class:'Маг',rarity:'Редкий',dmg:30,def:6,hp:24,crit:10,critDmg:24,baseDmg:30},
            {name:'Жезл чародея',icon:'🔮',img:'',tier:4,exp:420,time:10,resources:{'Мифриловая руда':6,'Изумруд':3,'Мифриловая нить':5,'Звездная пыльца':2},type:'weapon',class:'Маг',rarity:'Эпический',dmg:38,hp:48,crit:14,critDmg:30,dodge:6,baseDmg:38},
            {name:'Посох заклинаний',icon:'📜',img:'',tier:4,exp:440,time:10,resources:{'Мифриловая руда':6,'Рубин':3,'Мифриловая нить':5,'Звездная пыльца':2},type:'weapon',class:'Маг',rarity:'Эпический',dmg:43,hp:72,crit:17,critDmg:34,baseDmg:43},
            {name:'Посох короля-мага',icon:'👑',img:'',tier:5,exp:680,time:14,resources:{'Адамантит':6,'Алмаз':3,'Звёздный шёлк':3,'Звездная пыльца':3},type:'weapon',class:'Маг',rarity:'Легендарный',dmg:53,hp:60,crit:19,critDmg:36,baseDmg:53},
            {name:'Скипетр драконьей магии',icon:'🐉',img:'',tier:5,exp:700,time:14,resources:{'Адамантит':6,'Алмаз':3,'Звёздный шёлк':5,'Драконья чешуя':2},type:'weapon',class:'Маг',rarity:'Легендарный',dmg:60,def:10,hp:84,crit:17,critDmg:38,baseDmg:60},
            {name:'Жезл вечности',icon:'💎',img:'',tier:5,exp:800,time:15,resources:{'Адамантит':8,'Алмаз':5,'Звёздный шёлк':5,'Звездная пыльца':5},type:'weapon',class:'Маг',rarity:'Мифический',dmg:72,hp:96,crit:22,critDmg:46,dodge:6,baseDmg:72},
            
            // Древние/Божественные - ТОЛЬКО КРАФТ
            {name:'Посох древнего мага',icon:'🌌',img:'',tier:6,exp:900,time:18,resources:{'Орихалк':8,'Звездный камень':3,'Звёздный шёлк':5,'Звездная пыльца':5},type:'weapon',class:'Маг',rarity:'Древний',dmg:89,hp:120,crit:26,critDmg:54,dodge:6,baseDmg:89},
            {name:'Скипетр первозданной магии',icon:'✨',img:'',tier:6,exp:1000,time:18,resources:{'Орихалк':8,'Звездный камень':3,'Звёздный шёлк':6,'Камень душ':2},type:'weapon',class:'Маг',rarity:'Древний',dmg:106,def:12,hp:156,crit:24,critDmg:60,baseDmg:106},
            {name:'Посох абсолютной магии',icon:'🔮',img:'',tier:6,exp:1200,time:20,resources:{'Орихалк':9,'Звездный камень':5,'Звёздный шёлк':6,'Камень душ':3},type:'weapon',class:'Маг',rarity:'Божественный',dmg:114,hp:192,crit:34,critDmg:90,dodge:4,baseDmg:114},
            {name:'Жезл вселенной',icon:'🌠',img:'',tier:6,exp:1300,time:20,resources:{'Орихалк':10,'Звездный камень':5,'Звёздный шёлк':8,'Камень душ':3},type:'weapon',class:'Маг',rarity:'Божественный',dmg:132,hp:240,crit:38,critDmg:102,baseDmg:132},
            {name:'Скипетр божественной силы',icon:'👑',img:'',tier:6,exp:1500,time:22,resources:{'Орихалк':12,'Звездный камень':6,'Звёздный шёлк':8,'Камень душ':5},type:'weapon',class:'Маг',rarity:'Божественный',dmg:156,hp:300,crit:42,critDmg:120,baseDmg:156},
            {name:'Посох мироздания',icon:'🌟',img:'',tier:6,exp:1800,time:25,resources:{'Орихалк':14,'Звездный камень':8,'Звёздный шёлк':9,'Камень душ':6},type:'weapon',class:'Маг',rarity:'Божественный',dmg:180,hp:384,crit:48,critDmg:144,baseDmg:180}
        ],
        armor: [
            {name:'Хлопковая мантия',icon:'👘',img:'',tier:2,exp:80,time:4,resources:{'Хлопок':6},type:'chest',class:'Маг',rarity:'Необычный',def:6,hp:24,mana:24,baseDef:6},
            {name:'Хлопковый капюшон',icon:'🎭',img:'',tier:2,exp:60,time:3,resources:{'Хлопок':5},type:'helmet',class:'Маг',rarity:'Необычный',def:4,hp:14,mana:14,baseDef:4},
            {name:'Хлопковые штаны',icon:'👖',img:'',tier:2,exp:55,time:3,resources:{'Хлопок':5},type:'pants',class:'Маг',rarity:'Необычный',def:4,hp:12,mana:12,baseDef:4},
            {name:'Хлопковые сапоги',icon:'👢',img:'',tier:2,exp:55,time:3,resources:{'Хлопок':5},type:'boots',class:'Маг',rarity:'Необычный',def:4,dodge:4,mana:10,baseDef:4},
            {name:'Шёлковая мантия',icon:'👘',img:'',tier:3,exp:150,time:6,resources:{'Шёлк':6,'Паутина':3},type:'chest',class:'Маг',rarity:'Редкий',def:12,hp:42,mana:48,baseDef:12},
            {name:'Шёлковый капюшон',icon:'🎭',img:'',tier:3,exp:120,time:5,resources:{'Шёлк':5,'Паутина':2},type:'helmet',class:'Маг',rarity:'Редкий',def:8,hp:26,mana:30,baseDef:8},
            {name:'Шёлковые штаны',icon:'👖',img:'',tier:3,exp:100,time:4,resources:{'Шёлк':5,'Паутина':2},type:'pants',class:'Маг',rarity:'Редкий',def:7,hp:22,mana:24,baseDef:7},
            {name:'Шёлковые сапоги',icon:'👢',img:'',tier:3,exp:100,time:4,resources:{'Шёлк':5,'Паутина':2},type:'boots',class:'Маг',rarity:'Редкий',def:7,dodge:6,mana:22,baseDef:7},
            {name:'Мифриловое одеяние',icon:'✨',img:'',tier:4,exp:280,time:9,resources:{'Мифриловая нить':6,'Шёлк':3},type:'chest',class:'Маг',rarity:'Эпический',def:22,hp:66,mana:84,baseDef:22},
            {name:'Мифриловый капюшон',icon:'🎭',img:'',tier:4,exp:220,time:7,resources:{'Мифриловая нить':5,'Шёлк':3},type:'helmet',class:'Маг',rarity:'Эпический',def:14,hp:42,mana:54,baseDef:14},
            {name:'Мифриловые штаны',icon:'👖',img:'',tier:4,exp:200,time:7,resources:{'Мифриловая нить':5,'Шёлк':3},type:'pants',class:'Маг',rarity:'Эпический',def:12,hp:34,mana:42,baseDef:12},
            {name:'Мифриловые сапоги',icon:'👢',img:'',tier:4,exp:200,time:7,resources:{'Мифриловая нить':5,'Шёлк':3},type:'boots',class:'Маг',rarity:'Эпический',def:12,dodge:7,mana:36,baseDef:12},
            
            // Мифический звёздный сет (тир 6) — крафт
            {name:'Звёздное одеяние',icon:'🌟',img:'',tier:6,exp:500,time:14,resources:{'Звёздный шёлк':8,'Мифриловая нить':5,'Звездная пыльца':3},type:'chest',class:'Маг',rarity:'Мифический',def:38,hp:108,mana:144,baseDef:38},
            {name:'Звёздный капюшон',icon:'🎭',img:'',tier:6,exp:400,time:11,resources:{'Звёздный шёлк':6,'Мифриловая нить':3,'Звездная пыльца':2},type:'helmet',class:'Маг',rarity:'Мифический',def:26,hp:72,mana:96,baseDef:26},
            {name:'Звёздные штаны',icon:'👖',img:'',tier:6,exp:380,time:11,resources:{'Звёздный шёлк':6,'Мифриловая нить':3,'Звездная пыльца':2},type:'pants',class:'Маг',rarity:'Мифический',def:22,hp:60,mana:78,baseDef:22},
            {name:'Звёздные сапоги',icon:'👢',img:'',tier:6,exp:380,time:11,resources:{'Звёздный шёлк':6,'Мифриловая нить':3,'Звездная пыльца':2},type:'boots',class:'Маг',rarity:'Мифический',def:22,dodge:10,mana:66,baseDef:22},

            // Древние/Божественные — ТОЛЬКО КРАФТ
            {name:'Капюшон звёздного пророка',icon:'🔮',img:'',tier:6,exp:800,time:15,resources:{'Орихалк':6,'Звёздный шёлк':5,'Звездный камень':2},type:'helmet',class:'Маг',rarity:'Древний',def:46,hp:132,mana:120,crit:18,critDmg:14,baseDef:46},
            {name:'Диадема небесного чародея',icon:'✨',img:'',tier:6,exp:900,time:16,resources:{'Орихалк':8,'Звёздный шёлк':6,'Звездный камень':3,'Камень душ':2},type:'helmet',class:'Маг',rarity:'Божественный',def:69,hp:168,mana:156,crit:22,dodge:4,baseDef:69},
            {name:'Венец манапотока',icon:'💫',img:'',tier:6,exp:1000,time:17,resources:{'Орихалк':9,'Звёздный шёлк':7,'Звездный камень':3,'Камень душ':3},type:'helmet',class:'Маг',rarity:'Божественный',def:79,hp:216,mana:192,crit:26,critDmg:12,baseDef:79},
            {name:'Корона первозданной мудрости',icon:'👑',img:'',tier:6,exp:1200,time:18,resources:{'Орихалк':10,'Звёздный шёлк':8,'Звездный камень':5,'Камень душ':5},type:'helmet',class:'Маг',rarity:'Божественный',def:97,hp:276,mana:240,crit:28,critDmg:18,baseDef:97},

            {name:'Мантия древнего архимага',icon:'🌌',img:'',tier:6,exp:900,time:16,resources:{'Орихалк':8,'Звёздный шёлк':6,'Звездный камень':3,'Адамантит':4},type:'chest',class:'Маг',rarity:'Древний',def:72,hp:240,mana:192,critDmg:16,dodge:6,baseDef:72},
            {name:'Одеяние звёздного суверена',icon:'✨',img:'',tier:6,exp:1000,time:17,resources:{'Орихалк':9,'Звёздный шёлк':7,'Звездный камень':3,'Камень душ':3},type:'chest',class:'Маг',rarity:'Божественный',def:112,hp:300,mana:240,dodge:8,baseDef:112},
            {name:'Роба божественного прорицания',icon:'🔮',img:'',tier:6,exp:1200,time:18,resources:{'Орихалк':10,'Звёздный шёлк':8,'Звездный камень':5,'Камень душ':5},type:'chest',class:'Маг',rarity:'Божественный',def:133,hp:372,mana:288,critDmg:20,dodge:10,baseDef:133},
            {name:'Мантия творца миров',icon:'🌟',img:'',tier:6,exp:1500,time:20,resources:{'Орихалк':12,'Звёздный шёлк':9,'Звездный камень':6,'Камень душ':6,'Звездная пыльца':4},type:'chest',class:'Маг',rarity:'Божественный',def:158,hp:456,mana:336,crit:8,critDmg:24,dodge:12,baseDef:158},

            {name:'Штаны древнего мудреца',icon:'📜',img:'',tier:6,exp:700,time:13,resources:{'Орихалк':6,'Звёздный шёлк':5,'Звездная пыльца':3},type:'pants',class:'Маг',rarity:'Древний',def:54,hp:168,mana:144,critDmg:10,dodge:8,baseDef:54},
            {name:'Порты магического вознесения',icon:'💫',img:'',tier:6,exp:800,time:14,resources:{'Орихалк':8,'Звёздный шёлк':6,'Звездный камень':3,'Камень душ':2},type:'pants',class:'Маг',rarity:'Божественный',def:79,hp:216,mana:168,crit:10,dodge:10,baseDef:79},
            {name:'Штаны звёздного паломника',icon:'🌠',img:'',tier:6,exp:900,time:15,resources:{'Орихалк':9,'Звёздный шёлк':7,'Звездный камень':5,'Камень душ':3},type:'pants',class:'Маг',rarity:'Божественный',def:94,hp:276,mana:204,critDmg:16,dodge:12,baseDef:94},
            {name:'Набедренники тайницы',icon:'🔱',img:'',tier:6,exp:1100,time:16,resources:{'Орихалк':10,'Звёздный шёлк':8,'Звездный камень':5,'Камень душ':5,'Звездная пыльца':3},type:'pants',class:'Маг',rarity:'Божественный',def:113,hp:348,mana:252,crit:8,dodge:14,baseDef:113},

            {name:'Сапоги лунного шага',icon:'🌙',img:'',tier:6,exp:600,time:13,resources:{'Орихалк':6,'Звёздный шёлк':5,'Звездная пыльца':3},type:'boots',class:'Маг',rarity:'Древний',def:28,hp:120,mana:108,dodge:28,baseDef:28},
            {name:'Тапочки эфирного странника',icon:'👣',img:'',tier:6,exp:700,time:14,resources:{'Орихалк':8,'Звёздный шёлк':6,'Звездный камень':3,'Камень душ':2},type:'boots',class:'Маг',rarity:'Божественный',def:43,hp:156,mana:132,dodge:36,baseDef:43},
            {name:'Сапоги манавихря',icon:'💨',img:'',tier:6,exp:800,time:15,resources:{'Орихалк':9,'Звёздный шёлк':7,'Звездный камень':5,'Камень душ':3},type:'boots',class:'Маг',rarity:'Божественный',def:51,hp:204,mana:156,crit:8,dodge:42,baseDef:51},
            {name:'Тапочки созидателя',icon:'⚡',img:'',tier:6,exp:1000,time:16,resources:{'Орихалк':10,'Звёздный шёлк':8,'Звездный камень':5,'Камень душ':5,'Звездная пыльца':3},type:'boots',class:'Маг',rarity:'Божественный',def:63,hp:264,mana:180,critDmg:10,dodge:48,baseDef:63}
        ]
    },
