...
const CRAFTING_RECIPES = {
    ...
    'alchemy': {
        potions: [
            ...
            {name:'Зелье здоровья',icon:'🧪',img:'',tier:2,exp:60,time:3,resources:{'Лечебная трава':8,'Синий корень':2},type:'potion',effect:'heal',value:144,rarity:'Необычный', sellPrice: 50},
            {name:'Большое зелье здоровья',icon:'🧪',img:'',tier:3,exp:120,time:5,resources:{'Лечебная трава':8,'Сердце леса':3, 'Огненный цветок': 4},type:'potion',effect:'heal',value:300,rarity:'Редкий'},
