...
const CRAFTING_RECIPES = {
    ...
    'tailoring': {
        weapons: [
            ...
            {name:'Посох абсолютной магии',icon:'🔮',img:'png/weapons/mage/mage_staff_14.png',tier:6,exp:1200,time:20,resources:{'Орихалк':9,'Звездный камень':5,'Звёздный шёлк':6,'Камень душ':3},type:'weapon',class:'Маг',rarity:'Божественный',dmg:114,hp:192,crit:34,critDmg:90,dodge:4,baseDmg:114},
            {name:'Жезл вселенной',icon:'🌠',img:'png/weapons/mage/mage_staff_15.png',tier:6,exp:1300,time:20,resources:{'Орихалк':10,'Звездный камень':5,'Звёздный шёлк':8,'Камень душ':3},type:'weapon',class:'Маг',rarity:'Божественный',dmg:132,hp:240,crit:38,critDmg:102,baseDmg:132},
            {name:'Скипетр божественной силы',icon:'👑',img:'png/weapons/mage/mage_staff_16.png',tier:6,exp:1500,time:22,resources:{'Орихалк':12,'Звездный камень':6,'Звёздный шёлк':8,'Камень душ':5},type:'weapon',class:'Маг',rarity:'Божественный',dmg:156,hp:300,crit:42,critDmg:120,baseDmg:156},
            {name:'Посох мироздания',icon:'🌟',img:'png/weapons/mage/mage_staff_17.png',tier:6,exp:1800,time:25,resources:{'Орихалк':14,'Звездный камень':8,'Звёздный шёлк':9,'Камень душ':6},type:'weapon',class:'Маг',rarity:'Божественный',dmg:180,hp:384,crit:48,critDmg:144,baseDmg:180}
        ],
        armor: [
