...
const CRAFTING_RECIPES = {
    ...
    'tailoring': {
        ...
        armor: [
            ...
            // Сет Ледяного дракона (Легендарный, тир 5) — крафт
            {name:'Шлем ледяного дракона',icon:'🐉',img:'png/armor/mage/ice-helm.png',tier:5,exp:450,time:12,resources:{'Адамантит':5,'Алмаз':3,'Чешуя ледяного дракона':3},type:'helmet',class:'Маг',rarity:'Легендарный',def:15,hp:55,crit:9,baseDef:15},
            {name:'Нагрудник ледяного дракона',icon:'🐉',img:'png/armor/mage/ice-nag.png',tier:5,exp:550,time:14,resources:{'Адамантит':6,'Алмаз':4,'Чешуя ледяного дракона':4},type:'chest',class:'Маг',rarity:'Легендарный',def:22,hp:85,crit:7,critDmg:12,baseDef:22},
            ...
            // Мифический сет Некроманта (тир 6)
            ...
            {name:'Поножи Ктулху',icon:'🐙',img:'png/armor/mage/kth-wtan.png',tier:6,exp:800,time:600,resources:{'Орихалк':8,'Звёздный шёлк':6,'Звездный камень':3,'Эссенция Ктулху':2},type:'pants',class:'Маг',rarity:'Божественный',def:79,hp:216,mana:168,crit:10,dodge:10,baseDef:79},
            {name:'Сапоги Ктулху',icon:'🐙',img:'png/armor/mage/kth-buc.png',tier:6,exp:700,time:600,resources:{'Орихалк':8,'Звёздный шёлк':6,'Звездный камень':3,'Эссенция Ктулху':2},type:'boots',class:'Маг',rarity:'Божественный',def:43,hp:156,mana:132,dodge:36,baseDef:43},

            // === СЕТ ДРЕВНЕГО ПОЖИРАТЕЛЯ СВЕТА (Божественный) ===
            {name:'Шлем Древнего Пожирателя Света',icon:'🌑',img:'png/armor/mage/let-helm.png',tier:6,exp:920,time:600,resources:{'Орихалк':8,'Звёздный шёлк':6,'Звездный камень':3,'Эссенция Призрачного Мотылька':2},type:'helmet',class:'Маг',rarity:'Божественный',def:72,hp:174,mana:162,crit:24,dodge:5,baseDef:72},
            {name:'Нагрудник Древнего Пожирателя Света',icon:'🌑',img:'png/armor/mage/let-nag.png',tier:6,exp:1040,time:600,resources:{'Орихалк':9,'Звёздный шёлк':7,'Звездный камень':3,'Эссенция Призрачного Мотылька':3},type:'chest',class:'Маг',rarity:'Божественный',def:118,hp:312,mana:252,dodge:9,baseDef:118},
            {name:'Поножи Древнего Пожирателя Света',icon:'🌑',img:'png/armor/mage/let-wtan.png',tier:6,exp:820,time:600,resources:{'Орихалк':8,'Звёздный шёлк':6,'Звездный камень':3,'Эссенция Призрачного Мотылька':2},type:'pants',class:'Маг',rarity:'Божественный',def:82,hp:222,mana:174,crit:11,dodge:11,baseDef:82},
            {name:'Сапоги Древнего Пожирателя Света',icon:'🌑',img:'png/armor/mage/let-buc.png',tier:6,exp:720,time:600,resources:{'Орихалк':8,'Звёздный шёлк':6,'Звездный камень':3,'Эссенция Призрачного Мотылька':2},type:'boots',class:'Маг',rarity:'Божественный',def:45,hp:162,mana:138,dodge:38,baseDef:45},

            // === ОТДЕЛЬНЫЕ БОЖЕСТВЕННЫЕ ПРЕДМЕТЫ ===
