        ...
        monsters:[
            {name:'Пламенный саламандр',icon:'🦎',img:'./monsters/fireSlamandr.png',hp:1400,atk:150,exp:210,def:30,
                abilities:[
                    ...
                    {name:'Горение',type:'dot',effect:'burn',value:10,duration:2,chance:50,cooldown:3},
                    {name:'Огненный щит',type:'buff',effect:'reflect',value:20,duration:2,chance:30,cooldown:4}
                ]},
