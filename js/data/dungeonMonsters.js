// dungeonMonsters.js — уникальные враги подземелий (арт ./monsters/dungeon/)
...
const DUNGEON_MONSTERS_DB = [
    ...
    },
    {
        ...
        icon: '✨',
        img: './monsters/dungeon/crystal-wisp.png',
        hp: 620,
        atk: 88,
        def: 16,
        exp: 118,
    ...
    },
    {
        ...
        icon: '💎',
        img: './monsters/dungeon/crystal-sentinel.png',
        hp: 1280,
        atk: 102,
        def: 34,
        exp: 228,
    ...
    },
    {
        ...
        name: 'Тень бездны',
        icon: '👤',
        img: './monsters/dungeon/void-shade.png',
        hp: 780,
        atk: 112,
        def: 18,
        exp: 142,
    ...
    },
    {
        ...
        icon: '🍄',
        img: './monsters/dungeon/spore-cap.png',
        hp: 580,
        atk: 78,
        def: 16,
        exp: 112,
    ...
    },
    {
        ...
        name: 'Матриарх спор',
        icon: '👑',
        img: './monsters/dungeon/fungal-matriarch.png',
        hp: 1220,
        atk: 100,
        def: 32,
        exp: 220,
    ...
    },
    {
        ...
        icon: '❄️',
        img: './monsters/dungeon/frost-lurker.png',
        hp: 700,
        atk: 96,
        def: 18,
        exp: 128,
    ...
    },
    {
        ...
        name: 'Сердце ледника',
        icon: '💠',
        img: './monsters/dungeon/glacier-heart.png',
        hp: 1380,
        atk: 110,
        def: 38,
        exp: 242,
    ...
    },
    {
        ...
        name: 'Небесный дрон',
        icon: '🛸',
        img: './monsters/dungeon/sky-drone.png',
        hp: 820,
        atk: 118,
        def: 20,
        exp: 148,
    ...
    },
    {
        ...
        icon: '☁️',
        img: './monsters/dungeon/cloud-stalker.png',
        hp: 900,
        atk: 124,
        def: 22,
        exp: 162,
